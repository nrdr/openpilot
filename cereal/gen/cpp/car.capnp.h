...
public:
  ...
  inline float getLeadVLead() const;
...
public:
  ...
  inline float getLeadVLead();
  inline void setLeadVLead(float value);
...
inline float CarControl::HUDControl::Reader::getLeadVLead() const {
  return _reader.getDataField<float>(
      ::capnp::bounded<4>() * ::capnp::ELEMENTS);
}

inline float CarControl::HUDControl::Builder::getLeadVLead() {
  return _builder.getDataField<float>(
      ::capnp::bounded<4>() * ::capnp::ELEMENTS);
}
inline void CarControl::HUDControl::Builder::setLeadVLead(float value) {
  _builder.setDataField<float>(
      ::capnp::bounded<4>() * ::capnp::ELEMENTS, value);
}
