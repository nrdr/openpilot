...
procs = [
  ...
  PythonProcess("dmonitoringmodeld", "selfdrive.modeld.dmonitoringmodeld", driverview, enabled=False),  # nrdr: no driver camera on this build - DM never runs (baked in, no /data marker)
  ...
  PythonProcess("dmonitoringd", "selfdrive.monitoring.dmonitoringd", driverview, enabled=False),  # nrdr: no driver camera on this build - DM never runs (baked in, no /data marker)
