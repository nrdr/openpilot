"""Model-artifact policy for NRDR steer-ratio behavior.

This module is deliberately pure: callers provide a decoded mapping or a
capnp-shaped bundle, and only the aggregate SHA-256 of ``models[0]`` selects a
reviewed policy. Human-readable names and refs are audit metadata, never
runtime selectors.
"""
