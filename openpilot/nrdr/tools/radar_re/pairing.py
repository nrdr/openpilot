...
from openpilot.nrdr.tools.radar_re import BOSCH_RADAR_HDR_TAG, BOSCH_RADAR_LAT_SCALE_DEG_PER_LSB
from openpilot.nrdr.tools.radar_re.ingest import FrameRecord
