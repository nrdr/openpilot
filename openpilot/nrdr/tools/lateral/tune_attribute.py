...
Usage:
  python3 -m openpilot.nrdr.tools.lateral.tune_attribute <rlog> [<rlog> ...]
  python3 -m openpilot.nrdr.tools.lateral.tune_attribute /data/media/0/realdata/*/rlog.zst
"""
import sys
import numpy as np
...
def paramsd_context(lp):
  if lp["n"] == 0:
    print("paramsd context: no vehicleParameters in these logs.\n")
    return
