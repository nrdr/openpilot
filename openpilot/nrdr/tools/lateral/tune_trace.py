...
Usage:
  python3 -m openpilot.nrdr.tools.lateral.tune_trace <rlog> [<rlog> ...]
  python3 -m openpilot.nrdr.tools.lateral.tune_trace /data/media/0/realdata/*/rlog.zst | tee /data/nrdr_tune_trace.txt
