...
def test_clarity_raw_curve_is_exact_audited_artifact_and_endpoint_clamps():
  assert CLARITY_RAW_STEER_RATIO.angles_deg == RAW_ANGLES
  assert CLARITY_RAW_STEER_RATIO.ratios == RAW_RATIOS
  ...
  assert CLARITY_RAW_STEER_RATIO.ratio_at(-7.5) == pytest.approx(20.665984)
  assert CLARITY_RAW_STEER_RATIO.ratio_at(5.0) == pytest.approx((19.679678 + 20.665984) / 2.0)
  assert CLARITY_RAW_STEER_RATIO.ratio_at(1000.0) == pytest.approx(15.279368)
  assert CLARITY_RAW_STEER_RATIO.ratio_at(47.5) > CLARITY_RAW_STEER_RATIO.ratio_at(42.5)
