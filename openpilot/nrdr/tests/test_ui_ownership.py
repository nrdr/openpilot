...
UI_MODULES = {
  ...
  "openpilot.selfdrive.ui.sunnypilot.layouts.settings.nrdr_sub_layouts.steer_ratio_tuning": (
    "openpilot.nrdr.ui.settings.steer_ratio_tuning", ("SteerRatioTuningLayout",),
  ),
