...
PARAM_SPECS: tuple[ParamSpec, ...] = (
  ...
  _added("NrdrLearnSteerRatio", ParamType.BOOL, PB, "0", owner=ParamOwner.LATERAL),
  _added("NrdrSteerRatioCenterClarity", ParamType.FLOAT, PB, "18.50", owner=ParamOwner.LATERAL),
  _added("NrdrSteerRatioOuterClarity", ParamType.FLOAT, PB, "12.72", owner=ParamOwner.LATERAL),
  _added("NrdrSteerRatioCenterCivic", ParamType.FLOAT, PB, "17.24", owner=ParamOwner.LATERAL),
  _added("NrdrSteerRatioOuterCivic", ParamType.FLOAT, PB, "10.93", owner=ParamOwner.LATERAL),
  _added("NrdrSteerRatioCenterAccord", ParamType.FLOAT, PB, "18.31", owner=ParamOwner.LATERAL),
  _added("NrdrSteerRatioOuterAccord", ParamType.FLOAT, PB, "11.82", owner=ParamOwner.LATERAL),
  _added("NrdrSteerRatioCenterCrv5g", ParamType.FLOAT, PB, "17.94", owner=ParamOwner.LATERAL),
  ...
  _added("NrdrHandcraftedLateralTune", ParamType.BOOL, PB, "0", owner=ParamOwner.LATERAL),
