...
_EXPORT_MODULES = {
  ...
  "STEER_RATIO_ENDPOINT_PROFILE_BY_FP": "openpilot.nrdr.params.profiles",
  "STEER_RATIO_ENDPOINT_PROFILES": "openpilot.nrdr.params.profiles",
  "SteerRatioEndpointProfile": "openpilot.nrdr.params.profiles",
  ...
  "get_steer_ratio_endpoint_profile": "openpilot.nrdr.params.profiles",
