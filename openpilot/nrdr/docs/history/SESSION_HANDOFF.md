...
**Clarity tune DOUBLED** (`opendbc_repo/.../honda/interface.py`, most recent change): kp `[0.018,0.024,0.030]→[0.036,0.048,0.060]`, ki `[0.006,0.008,0.010]→[0.012,0.016,0.020]`, kf scalar `3.6e-6→7.2e-6` and banded kfV `[2.4e-6,1.8e-6,3.0e-6]→[4.8e-6,3.6e-6,6.0e-6]`. UI P/I/F scales stay 100% = the new neutral base. Note: doubling P+I doubles loop gain (watch low-speed ring; D + center boost are the levers). Recommended hitting **Reset Learned Trim** since the FF base moved 2×.
