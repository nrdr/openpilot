...
**Clarity tune DOUBLED** (`opendbc_repo/.../honda/interface.py`, most recent change): kp `[0.018,0.024,0.030]→[0.036,0.048,0.060]`, ki `[0.006,0.008,0.010]→[0.012,0.016,0.020]`, kf scalar `0.0000036→0.0000072` and banded kfV `[0.0000024,0.0000018,0.000003]→[0.0000048,0.0000036,0.000006]`. UI P/I/F scales stay 100% = the new neutral base. Note: doubling P+I doubles loop gain (watch low-speed ring; D + center boost are the levers). Recommended hitting **Reset Learned Trim** since the FF base moved 2×.
