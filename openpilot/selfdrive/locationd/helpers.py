...
class Pose:
  def __init__(self, orientation: Measurement, velocity: Measurement, acceleration: Measurement, angular_velocity: Measurement,
    ...
    # Pose's Measurement objects intentionally contain only values and standard
    # deviations. Preserve the source validity separately so consumers cannot
    # mistake a finite but invalid/stale gyro sample for a usable yaw rate.
