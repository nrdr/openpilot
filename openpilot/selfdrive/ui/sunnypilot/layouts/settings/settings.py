...
from openpilot.nrdr.ui.settings.layout import NrdrLayout
...
class SettingsLayoutSP(OP.SettingsLayout):
  def __init__(self):
    ...
    self._panels = {
      ...
      OP.PanelType.LANE_CENTERING: PanelInfo(tr_noop("Lane Centering"), LaneCenteringLayout(),
                                            icon="../../sunnypilot/selfdrive/assets/offroad/icon_lateral.png"),
