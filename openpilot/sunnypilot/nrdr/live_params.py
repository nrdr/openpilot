...
CONTROL_GROUPS = (
  ...
  ParamGroup(("HondaInjectionTest", "NrdrStarPilotPid", "NrdrLatStiction", "NrdrLegacyDualBpSteerRatio",
  ...
  *_STEER_RATIO_GROUPS,
  ...
  ParamGroup(("LongPidTuneScale", "StaticFeedforwardLong", "HondaStopAccel",
