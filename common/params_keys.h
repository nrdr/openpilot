...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"NrdrCurvServo", {PERSISTENT | BACKUP, BOOL, "0"}},            // pure-feedback setpoint servo: no SR map above ~10 mph (EXPERIMENTAL; overrides CurvatureTrim, run with TuneLearner OFF)
