...
class NrdrForkWidget(Widget):
  ...
  def _render(self, rect: rl.Rectangle):
    ...
    rl.draw_text_ex(title_font, title, rl.Vector2(x, y), 89, 0, rl.WHITE)
    ...
    for word in subtitle_words:
      ...
      if measure_text_cached(body_font, test_line, 50).x > w and subtitle_line:
    ...
    for word in words:
      ...
      if measure_text_cached(body_font, test_line, 41).x > max_line_width and line:
        lines.append(line)
        line = word
      else:
        line = test_line
