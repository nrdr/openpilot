...
FRICTION_Y_LOW_SPEED = [1.0, 0.5]    # stronger friction comp at low speed
FRICTION_Y_HIGH_SPEED = [1.0, 0.25]  # weaker friction comp at high speed

FRICTION_BLEND_START_MPH = 45.0
FRICTION_BLEND_END_MPH = 55.0
MPH_TO_MS = 0.44704
