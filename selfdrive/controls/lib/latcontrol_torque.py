...
class LatControlTorque(LatControl):
  def __init__(self, CP, CI):
    ...
    if self.use_nn or self.use_lateral_jerk:
      ...
      self.friction_look_ahead_v = [1.6, 2.0] # how many seconds in the future to look ahead in [0, ~2.1] in 0.1 increments
      ...
      self.lat_accel_friction_factor = 0.5 # in [0, 3], in 0.05 increments. 3 is arbitrary safety limit
