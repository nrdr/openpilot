...
class CarController(CarControllerBase):
  ...
  def update(self, CC, CS, now_nanos):
    ...
    hud_v_cruise = 252 if stopping_hud else hud_control.setSpeed / conversion if hud_control.speedVisible else CS.out.vEgo / conversion if CS.out.vEgo > 0.3 else 255
