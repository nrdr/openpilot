  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    if candidate == CAR.HONDA_CIVIC:
      if eps_modified:
        ...
        ret.lateralTuning.pid.kpBP, ret.lateralTuning.pid.kpV = [[0, 17, 22, 27], [0.12, 0.135, 0.15, 0.15]] # 3x [[0.1575], [0.05175]]
        ret.lateralTuning.pid.kiBP, ret.lateralTuning.pid.kiV = [[0, 17, 22], [0.025, 0.05, 0.05, 0.05]]
      else:
