  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    if candidate == CAR.HONDA_CIVIC:
      if eps_modified:
        ...
        ret.lateralTuning.pid.kpBP, ret.lateralTuning.pid.kpV = [[0, 11.176, 35.7632], [0.3, 0.12, 0.3]]  # 0 / 25 / 80 MPH
        ret.lateralTuning.pid.kiBP, ret.lateralTuning.pid.kiV = [[0, 11.176, 35.7632], [0.1, 0.04, 0.1]]  # 0 / 25 / 80 MPH
      else:
        ret.lateralTuning.pid.kf = 0.00006  # conservative feed-forward
