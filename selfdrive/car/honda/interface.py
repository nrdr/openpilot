  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    if candidate == CAR.HONDA_CIVIC:
      if eps_modified:
        ...
        ret.lateralTuning.pid.kpBP, ret.lateralTuning.pid.kpV = [[0, 17, 22, 27], [0.12, 0.135, 0.15, 0.3]] # 3x [[0.1575], [0.05175]]
        ret.lateralTuning.pid.kiBP, ret.lateralTuning.pid.kiV = [[0, 17, 22], [0.02, 0.05, 0.075, 0.1]]
      else:
        ret.lateralTuning.pid.kf = 0.00006  # conservative feed-forward
        ret.lateralParams.torqueBP = [0x0, 0x917, 0xDC5, 0x1017, 0x119F, 0x140B, 0x1680, 0x6540, 0x7080]
        ret.lateralParams.torqueV = [0x0, 0x200, 0x300, 0x478, 0x5EC, 0x800, 0xA00, 0xE00, 0xF00]
