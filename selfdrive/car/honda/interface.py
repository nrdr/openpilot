  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    if candidate == CAR.HONDA_CIVIC:
      if eps_modified:
        ...
        ret.lateralTuning.pid.kf = 0.0000588
        ...
        ret.lateralTuning.pid.kpBP, ret.lateralTuning.pid.kpV = [[0, 11.176, 35.7632], [0.15, 0.3, 0.24]]  # 0 / 25 / 80 MPH
        ret.lateralTuning.pid.kiBP, ret.lateralTuning.pid.kiV = [[0, 11.176, 35.7632], [0.05, 0.1, 0.08]]  # 0 / 25 / 80 MPH
      else:
        ret.lateralTuning.pid.kf = 0.00006  # conservative feed-forward
