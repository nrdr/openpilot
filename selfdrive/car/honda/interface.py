  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    if candidate == CAR.HONDA_CIVIC:
      if eps_modified:
        ...
        ret.lateralTuning.pid.kpBP, ret.lateralTuning.pid.kpV = [[0, 4.4704, 13.4112, 20.1168], [0.15, 0.15, 0.17, 0.2]]   # 0 / 10 / 30 / 45 MPH
        ret.lateralTuning.pid.kiBP, ret.lateralTuning.pid.kiV = [[0, 4.4704, 13.4112, 20.1168], [0.05, 0.05, 0.075, 0.09]]  # 0 / 10 / 30 / 45 MPH
      else:
        ret.lateralTuning.pid.kf = 0.00006  # conservative feed-forward
